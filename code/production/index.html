	...
	<nav id="nav">
		...
		<img alt="Light On" id="lightSwitchOn" title="Toggle Nightmode On" src="images/light-on.png"></img>
		<img alt="Light Off" id="lightSwitchOff" title="Toggle Nightmode Off" src="images/light-off.png"></img>
	</nav>
	<div id="mainContent">
		<div id="leftSideBar">
